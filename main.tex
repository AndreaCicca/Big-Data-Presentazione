...
\include{sections/3-Testing}
\include{sections/4-Evaluation}
\include{sections/5-Conclusion}
\include{sections/6-Appendicies}
...
\begin{frame}[plain] 
	...
	\end{center}
	\begin{itemize}
	    \item \href{https://apple.github.io/foundationdb/}{FoundationDB Documentation}
     \item \href{https://dl.acm.org/doi/10.1145/3592838}{FoundationDB: A Distributed Key-Value Store (acm)}
     \item \href{https://www.youtube.com/watch?v=EMwhsGsxfPU}{Technical Overview of FoundationDB - Evan Tschannen, Apple}
	 \item Kung, H.T., Robinson, J.T. On optimistic methods for concurrency control.
	 \item Bernstein, P.A., Hadzilacos, V., Goodman,N. Concurrency Control and Recovery in Database Systems.
	\end{itemize}
\end{frame}
